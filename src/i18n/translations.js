...
const translations = {
  de: {
    ...
    about: {
      ...
      aboutImage: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779236027/Gemini_Generated_Image_lzdc9hlzdc9hlzdc_1_ctjod7.png',
      ...
      historyBodyImage: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714167/suhail-security/other-companies-hero.png',
    ...
    referencesPage: {
      ...
      clients: [
        { slug: 'der-gruene-punkt', name: 'Der Grüne Punkt', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490775/suhail-security/ref-clients/der-gruene-punkt.png' },
        { slug: 'huf', name: 'Huf', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490779/suhail-security/ref-clients/huf.png' },
        { slug: 'intersport-voswinkel', name: 'Intersport Voswinkel', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490780/suhail-security/ref-clients/intersport-voswinkel.png' },
        { slug: 'makita', name: 'Makita', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490781/suhail-security/ref-clients/makita.png' },
        { slug: 'medion', name: 'Medion', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490782/suhail-security/ref-clients/medion.png' },
        { slug: 'blb-nrw', name: 'BLB NRW', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490772/suhail-security/ref-clients/blb-nrw.png' },
        { slug: 'currenta', name: 'Currenta', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490773/suhail-security/ref-clients/currenta.png' },
        { slug: 'funke-medien', name: 'Funke Medien Gruppe', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490778/suhail-security/ref-clients/funke-medien.png' },
        { slug: 'gasag', name: 'Gasag', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490779/suhail-security/ref-clients/gasag.png' },
        { slug: 'siemens', name: 'Siemens', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490787/suhail-security/ref-clients/siemens.png' },
        { slug: 'mkk', name: 'MKK', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490783/suhail-security/ref-clients/mkk.png' },
        { slug: 'nkg-kala-hamburg', name: 'NKG Kala Hamburg', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490784/suhail-security/ref-clients/nkg-kala-hamburg.png' },
        { slug: 'rhenus-logistics', name: 'Rhenus Logistics', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490785/suhail-security/ref-clients/rhenus-logistics.png' },
        { slug: 'sangro-homecare', name: 'Sangro homecare', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490785/suhail-security/ref-clients/sangro-homecare.jpg' },
        { slug: 'shell', name: 'Shell', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490786/suhail-security/ref-clients/shell.png' },
        { slug: 'sparkasse-essen', name: 'Sparkasse Essen', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490788/suhail-security/ref-clients/sparkasse-essen.png' },
        { slug: 'theresia-albers-stiftung', name: 'Theresia Albers Stiftung', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490789/suhail-security/ref-clients/theresia-albers-stiftung.png' },
        { slug: 'tmd-friction', name: 'TMD Friction', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490790/suhail-security/ref-clients/tmd-friction.png' },
        { slug: 'uni-duisburg-essen', name: 'Universität Duisburg-Essen', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490791/suhail-security/ref-clients/uni-duisburg-essen.png' },
        { slug: 'deutsches-historisches-museum', name: 'Deutsches Historisches Museum', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1777490776/suhail-security/ref-clients/deutsches-historisches-museum.png' },
      ],
    },
    qualityPage: {
      ...
      heroImage: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714125/suhail-security/quality-hero-certified.png',
    ...
    philosophyPage: {
      ...
      heroImage: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714146/suhail-security/philosophy-hero-collaboration.png',
    ...
    complianceLksgPage: {
      ...
      heroImage: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714151/suhail-security/compliance-hero-integrity.png',
    ...
    associationWorkPage: {
      ...
      heroImage: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714156/suhail-security/association-work-hero.png',
      engagementImage: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714161/suhail-security/association-work-engagement.png',
    ...
    csrPage: {
      ...
      heroImage: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714135/suhail-security/csr-hero-forest.png',
      ...
      ecologicalImage: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714140/suhail-security/csr-ecological-photo.png',
      ecologicalBullets: [
    ...
    otherCompaniesPage: {
      ...
      heroImage: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714167/suhail-security/other-companies-hero.png',
      activeBrandsHeading: 'Aktive Marken',
      activeBrands: [
        { slug: 'osd-schaefer', name: 'OSD SCHÄFER', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714169/suhail-security/other-companies/osd-schaefer.webp', body: '1979 gegründet, ist die OSD SCHÄFER GmbH & Co. KG (mit Sitz in Karlsruhe) seit 2014 eine hundertprozentige Tochtergesellschaft der KÖTTER Gruppe. Neben klassischen Sicherheitsdienstleistungen ist OSD SCHÄFER auf die Absicherung kritischer Infrastrukturen, insbesondere Kernanlagen und -einrichtungen, spezialisiert.' },
        { slug: 'gbp', name: 'German Business Protection', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714170/suhail-security/other-companies/german-business-protection.webp', body: 'German Business Protection (GBP) wurde 2012 von der KÖTTER Gruppe in Berlin gegründet. GBP bietet Unternehmen, Behörden, Nichtregierungsorganisationen (NGOs) und Privatpersonen Beratungsleistungen als integrierte Risikomanagementlösung mit den Schwerpunkten Sicherheit und Compliance.' },
        { slug: 'terapon', name: 'TERAPON', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714171/suhail-security/other-companies/terapon.jpg', body: 'Die TERAPON Consulting GmbH wurde 2007 von der KÖTTER Gruppe in Essen gegründet und ist auf effizientes Gesundheitsmanagement spezialisiert. Dazu gehören die schnelle, bundesweite und nachhaltige Betreuung traumatisierter oder anderweitig psychisch belasteter Personen.' },
        { slug: 'medgravity', name: 'MedGravity', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714172/suhail-security/other-companies/medgravity.png', body: 'Zum 1. Januar 2023 hat die KÖTTER Gruppe alle Anteile an der Hannoveraner MedGravity übernommen. MedGravity ist auf die Aus- und Weiterbildung von Ersthelfern sowie Betriebs-, Rettungs- und Notfallsanitätern spezialisiert und ergänzt damit ideal das Angebot der KÖTTER Akademie.' },
        { slug: 'stuk', name: 'STuK Sicherheitstechnik', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714173/suhail-security/other-companies/stuk.png', body: 'Mit Wirkung zum 1. Januar 2025 hat die KÖTTER Gruppe das norddeutsche Unternehmen STuK Sicherheitstechnik GmbH übernommen. Dieser strategische Schritt ermöglicht es, die Kompetenz in der Sicherheitstechnik und im technischen Brandschutz weiter auszubauen.' },
      ],
      portfolioBrands: [],
      integratedBrandsHeading: 'Integrierte Marken',
      integratedBrands: [
        { slug: 'wako', name: 'WAKO Group', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714174/suhail-security/other-companies/wako.png', body: 'Die in Stade ansässige WAKO-Gruppe ist mit all ihren Tochtergesellschaften seit 2024 eine hundertprozentige Tochter der KÖTTER Gruppe. Mit dem Rebranding 2026 wurde das Unternehmen vollständig in die bestehenden Gesellschaften der KÖTTER Gruppe integriert.' },
        { slug: 'arndt', name: 'ARNDT-Group', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714175/suhail-security/other-companies/arndt.jpg', body: 'Die in Fürth ansässige ARNDT-Gruppe wurde 1925 in Nürnberg gegründet und ist seit 2018 eine hundertprozentige Tochtergesellschaft der KÖTTER Gruppe. 1992 war ARNDT das erste Sicherheitsunternehmen in Deutschland, das nach DIN ISO 9000 ff. zertifiziert wurde. 2022 erfolgte die Fusion mit den bestehenden Gesellschaften der KÖTTER Sicherheitsgruppe.' },
        { slug: 'ise', name: 'I.S.E. Alarm-Service Berlin GmbH', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714176/suhail-security/other-companies/ise-alarm.webp', body: 'Die I.S.E. Alarm-Service Berlin GmbH wurde 2002 in der Hauptstadt gegründet und ist auf Alarmverfolgung, Interventionsdienste, Aufzugsrettung und Streifendienste spezialisiert. 2019 wurde I.S.E. von KÖTTER Security (Berlin) übernommen und 2022 fusioniert.' },
        { slug: 'inter', name: 'INTER Group', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714178/suhail-security/other-companies/intergruppe.webp', body: '1976 gegründet, wurde die INTER-Gruppe (mit den Sparten INTERSCHUTZ, INTERCLEAN und INTERSERVICE) mit Sitz in Bonn 2011 von der KÖTTER Gruppe übernommen. Mit dem Namenswechsel 2013 wurde das Unternehmen vollständig in die bestehenden Gesellschaften der KÖTTER Gruppe integriert.' },
        { slug: 'wsp', name: 'Wachschutz Paderborn', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714179/suhail-security/other-companies/wachschutz.webp', body: '1968 gegründet und hauptsächlich in Ostwestfalen tätig, trat das Paderborner Sicherheitsunternehmen 2008 der KÖTTER Gruppe bei. Seit 2009 firmiert das Unternehmen als KÖTTER Security GmbH.' },
        { slug: 'gsw', name: 'GSW Sicherheit und Werkschutz', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714180/suhail-security/other-companies/gswsicherheit.jpg', body: 'Die „GSW Sicherheit und Werkschutz GmbH" wurde 1999 in Saarbrücken gegründet und trat 2008 der KÖTTER Gruppe bei. Mit dem Namenswechsel 2011 wurde das Unternehmen vollständig in ein Unternehmen der KÖTTER Gruppe integriert.' },
        { slug: 'buerder', name: 'Wachdienst Bürder', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714180/suhail-security/other-companies/burder.jpg', body: '1964 im Ruhrgebiet gegründet, trat der Bürder-Wachdienst 2006 der KÖTTER Gruppe bei. Der Firmenname wurde 2008 geändert und damit die Integration in die KÖTTER Gruppe abgeschlossen.' },
        { slug: 'abakus', name: 'ABAKUS Personalüberlassung', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714181/suhail-security/other-companies/abakus.webp', body: 'Die 1993 gegründete und in Köln ansässige ABAKUS Personalüberlassung GmbH wurde 2005 von KÖTTER Personal Service übernommen. Die Integration in die KÖTTER Gruppe wurde mit der Umbenennung 2007 abgeschlossen.' },
        { slug: 'control', name: 'Control Risk Management', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714182/suhail-security/other-companies/control-risk-management.jpg', body: 'Die in Norddeutschland gegründete Control Risk Management GmbH ist seit Anfang 2005 Teil der KÖTTER Gruppe.' },
        { slug: 'bielefelder', name: 'Bielefelder Heimschutz', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714183/suhail-security/other-companies/bielefelder-heimschutz.png', body: 'Der Bielefelder Heimschutz wurde 1933 gegründet und 2004 von der KÖTTER Gruppe übernommen. 2007 wurde das Unternehmen in KÖTTER Security GmbH umbenannt.' },
        { slug: 'duesseldorfer', name: 'Düsseldorfer Wach- und Schließgesellschaft', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714184/suhail-security/other-companies/duesseldorfer-crop.webp', body: 'Das Düsseldorfer Sicherheits- und Schließunternehmen wurde 1903 gegründet und 1995 von der KÖTTER Gruppe übernommen. Mit dem Namenswechsel im August 2009 wurde es vollständig in eine Gesellschaft der KÖTTER Gruppe integriert.' },
      ],
    },
  },
  en: {
    ...
    otherCompaniesPage: {
      ...
      activeBrands: [
        ...
        { slug: 'medgravity', name: 'MedGravity', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714172/suhail-security/other-companies/medgravity.png', body: 'To January 1, 2023, the KÖTTER Group acquired all shares in Hanover-based MedGravity. MedGravity specializes in the training and continuing education of first responders, as well as company, rescue, and emergency paramedics, thus ideally complementing the offerings of the KÖTTER Academy.' },
        { slug: 'stuk', name: 'STuK Sicherheitstechnik', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714173/suhail-security/other-companies/stuk.png', body: 'With effect from January 1, 2025, the KÖTTER Group has acquired the northern German company STuK Sicherheitstechnik GmbH. This strategic move allows us to further strengthen and expand our expertise in security technology and technical fire protection.' },
      ],
      portfolioBrands: [],
      integratedBrandsHeading: 'Integrated brands',
      integratedBrands: [
        { slug: 'wako', name: 'WAKO Group', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714174/suhail-security/other-companies/wako.png', body: 'The Stade-based WAKO Group, with all its subsidiaries, has been a wholly owned subsidiary of the KÖTTER Group since 2024. With the rebranding in 2026, the company was fully integrated into the existing entities of the KÖTTER Group.' },
        ...
        { slug: 'ise', name: 'I.S.E. Alarm-Service Berlin GmbH', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714176/suhail-security/other-companies/ise-alarm.webp', body: 'I.S.E. Alarm-Service Berlin GmbH was founded in the capital in 2002 and specializes in alarm tracking, intervention services, elevator rescue, and patrol services. In 2019, I.S.E. Alarm-Service Berlin GmbH was acquired by KÖTTER Security (Berlin) and merged with it in 2022.' },
        ...
        { slug: 'abakus', name: 'ABAKUS Personalüberlassung', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714181/suhail-security/other-companies/abakus.webp', body: 'ABAKUS Personalüberlassung GmbH, founded in 1993 and based in Cologne, was acquired by KÖTTER Personal Service in 2005. The company\'s integration into the KÖTTER Group was completed with the name change in 2007.' },
        { slug: 'control', name: 'Control Risk Management', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714182/suhail-security/other-companies/control-risk-management.jpg', body: 'Control Risk Management GmbH, founded in northern Germany, has been part of the KÖTTER Group since the beginning of 2005.' },
        { slug: 'bielefelder', name: 'Bielefelder Heimschutz', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714183/suhail-security/other-companies/bielefelder-heimschutz.png', body: 'Bielefeld Home Protection was founded in 1933 and acquired by the KÖTTER Group in 2004. In 2007, the company was renamed KÖTTER Security GmbH.' },
        { slug: 'duesseldorfer', name: 'Düsseldorfer Wach- und Schließgesellschaft', logo: 'https://res.cloudinary.com/df7obwqcy/image/upload/v1779714184/suhail-security/other-companies/duesseldorfer-crop.webp', body: 'The Düsseldorf-based security and locking company, founded in 1903, was acquired by the KÖTTER Group in 1995. With the name change in August 2009, it was fully integrated into an existing company of the KÖTTER Group.' },
      ],
    },
  },
}
