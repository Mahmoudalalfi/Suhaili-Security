            ...
            .map((phone) => (
              <div key={phone} className="contact-detail-row">
                ...
                <div>
                  ...
                  <a href={`tel:${phone.replace(/\s/g, '')}`} className="contact-detail-link" style={{ fontWeight: 700 }}>
                    {phone}
                  </a>
                </div>
              </div>
          ...
          <>
            ...
            <div style={{ display: 'flex', gap: 16, alignItems: 'center', marginTop: 12 }}>
                ...
                <a
                  ...
                  style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '7px 16px', borderRadius: 999, background: '#25D366', color: '#fff', fontSize: 13, fontWeight: 700, textDecoration: 'none', transition: 'background 0.2s, transform 0.15s' }}
