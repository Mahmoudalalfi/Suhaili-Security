/**
 * English privacy policy body (structure aligned with suhaili-services reference).
 * Controller / contact adapted to Suhaili Security imprint data.
 */
...
export const privacySectionsEn = [
  ...
  },
  {
    ...
    title: 'Information on the collection of personal data',
    blocks: [
      {
        type: 'p',
        text:
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text: '(1) You have the following rights with respect to your personal data processed by us:',
      },
      {
        type: 'ul',
        items: [
      ...
      {
        type: 'p',
        text: 'Berlin Commissioner for Data Protection and Information Security',
      },
      {
        type: 'p',
        text: 'Postal address: Friedrichstraße 219, 10969 Berlin, Germany',
      },
      { type: 'p', text: 'Website: https://www.datenschutz-berlin.de' },
    ],
  },
  {
    id: 'collection-website',
    title: 'Collection of personal data when using our website',
    blocks: [
      {
        type: 'p',
        text:
  ...
  {
    id: 'further-functions',
    title: 'Further functions and offerings of our website',
    blocks: [
      {
        type: 'p',
        text:
  ...
  },
  {
    ...
    title: 'Objection to or revocation of consent to the processing of your data',
    blocks: [
      {
        type: 'p',
        text:
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: 'p',
        text:
          '(5) Information on the third-party service provider: CleverReach GmbH & Co. KG, Mühlenstraße 43, 26180 Rastede, Germany; you can find further information on data protection at CleverReach on CleverReach’s website: https://www.cleverreach.com/en/privacy/.',
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: 'p',
        text:
          'To ensure appropriate guarantees for the protection of the transfer and processing of personal data outside the EU, standard data protection clauses — EU SCC (Art. 46 para. 2 p. 1 lit. c GDPR) have been concluded with Facebook.',
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: 'p',
        text:
          'To ensure appropriate safeguards for the protection of the transfer and processing of personal data outside the EU, standard data protection clauses — EU SCC (Art. 46 para. 2 p. 1 lit. c GDPR) have been concluded with Instagram.',
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: 'p',
        text:
          'To ensure appropriate safeguards for the protection of the transfer and processing of personal data outside the EU, standard data protection clauses — EU SCC (Art. 46 para. 2 p. 1 lit. c GDPR) have been concluded with Twitter.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text:
          'A button referencing TikTok, provider TikTok Technology Limited, One Earlsfort Business Park, Hatch Street, Dublin 2, D02 T380, Ireland, may be integrated on our page where applicable. Typically this button is merely a link to our TikTok profile; we have no influence on the processing of your personal data by the companies jointly responsible for the respective presence. Data processing by TikTok intensifies principally when you follow the external link or use TikTok’s services thereafter. You can find TikTok’s privacy policy here: https://www.tiktok.com/legal/page/eea/privacy-policy/en.',
      },
      {
        type: 'p',
        text:
          'To ensure appropriate safeguards for the transfer and processing of personal data outside the EU and the EEA, TikTok describes international transfers and safeguards (including standard contractual clauses where applicable) in its privacy notices. Please refer to the policy linked above.',
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: 'p',
        text:
          'To ensure appropriate safeguards for the protection of the transfer and processing of personal data outside the EU, standard data protection clauses — EU-SCC (Art. 46 para. 2 p. 1 lit. c GDPR) have been concluded with Google Ireland Limited.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text:
          'A button of the social network Xing, provider New Work SE, with headquarters at Am Strandkai 1, 20457 Hamburg, Germany, is integrated on our page. This button is merely a link to our Xing profile. As a rule, we have no influence on the processing of your personal data by the companies jointly responsible for the company presence. Data processing by Xing only takes place when you click the Xing button at the top of our website. You can find Xing\'s data protection declaration at: https://privacy.xing.com/en/privacy-policy.',
      },
      {
        type: 'p',
        text:
          'To ensure appropriate safeguards for the protection of the transfer and processing of personal data outside the EU, standard data protection clauses — EU-SCC (Art. 46 para. 2 p. 1 lit. c GDPR) have been concluded with New Work SE.',
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: 'p',
        text:
          'To ensure appropriate safeguards for the protection of the transfer and processing of personal data outside the EU, standard data protection clauses — EU SCC (Art. 46 para. 2 p. 1 lit. c GDPR) have been concluded with LinkedIn.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text:
          'Suhaili Security may offer a dedicated channel on WhatsApp Business to keep subscribers informed regarding our activities, where applicable. Subscribers and administrators cannot view phone numbers via channels in the usual way. WhatsApp users can subscribe to such a channel and unsubscribe at any time. To use WhatsApp channels, the user must agree to the supplementary privacy policy on WhatsApp channels: https://www.whatsapp.com/legal/channels-privacy-policy-eea?lang=en.',
      },
      {
        type: 'p',
        text:
          'Where we integrate a WhatsApp button, provider Meta Platforms Ireland Limited, 4 Grand Canal Square, Grand Canal Harbour, Dublin 2, Ireland — for example on a Jobs & Careers page — this button is simply a link to a WhatsApp chat with our recruiters, if offered. Recruitment-related processing follows our applicant privacy notices where published; comprehensive technical and organisational measures are aimed at data protection-compliant use of WhatsApp in recruiting. As a rule, we have no influence on the processing of your personal data by Meta as joint controller beyond what is described here. Data processing attributable to WhatsApp’s infrastructure principally intensifies when you click the WhatsApp button in a relevant job advertisement. You can find WhatsApp\'s privacy policy at: https://www.whatsapp.com/legal/privacy-policy/?lang=en.',
      },
      {
        type: 'p',
        text:
          'To ensure appropriate safeguards for the protection of the transfer and processing of personal data outside the EU, standard data protection clauses — EU-SCC (Art. 46 para. 2 p. 1 lit. c GDPR) have been concluded with Meta Platforms Ireland Limited.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text:
          'The website contains links to external websites, including social media providers, such as Facebook, X/TikTok, etc. These links are embedded in such a way that excludes the automated forwarding of your user data. These providers only receive information about you if you select the links by clicking on these. As we have no influence over any external websites, we cannot accept any responsibility for the content and data protection policy of these.',
      },
    ],
  },
  {
    id: 'google-adwords',
    title: 'Use of Google AdWords Conversion',
    blocks: [
      {
        type: 'p',
        text:
    ...
    blocks: [
      {
        type: 'p',
        text:
          'The content of this website is protected by copyright. Without written permission from Suhaili Security, the content of this website may not be reproduced in any form (photocopy, microfilm or any other process) or processed, copied or disseminated by means of electronic systems, unless anything to the contrary has been explicitly indicated.',
      },
    ],
  },
  {
    id: 'exclusion-liability',
    title: 'Exclusion of liability',
    blocks: [
      {
        type: 'p',
        text:
          '(1) This website constitutes the temporary state of a continuous working process. Although the utmost care was taken in compiling the information contained on our website, Suhaili Security assumes no guarantee that this information is up-to-date, accurate or complete. This also applies for all links to which this website refers either directly or indirectly. Suhaili Security is not responsible for the content of a website which may be reached via such a link. Under no circumstances can Suhaili Security be held liable for damages of whatever nature that arise through the use or in relation to the use of the information provided here, be they direct or indirect damages or consequential damages, including lost profits or damages that result from the loss of data.',
      },
      {
        type: 'p',
        text:
  ...
  {
    id: 'brand-trademarks',
    title: 'Brand names and trademarks',
    blocks: [
      {
        type: 'p',
        text:
    ...
    blocks: [
      {
        type: 'p',
        text:
          'We take very careful precautions to protect your data against loss, manipulation and unauthorised access. The precautions correspond to the state of the art within the meaning of Article 32 GDPR.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: 'p',
        text:
          'On the Suhaili Security website we may offer you the opportunity to take part in competitions. In order to take part in the competitions, we collect personal data as required, such as: salutation, name, address (zip code and city), telephone number, email address and, if applicable, company. For internal competitions, the personnel number may also be requested. Please note that if you provide your company, we may pass on your data to our customer service team for further contact.',
      },
      {
        type: 'p',
        text:
  ...
  {
    id: 'prediction-game',
    title: 'Terms and Conditions for the Prediction Game',
    blocks: [
      {
        type: 'p',
        text:
          'Participation in the prediction game, hereinafter referred to as the operator or organizer, is free of charge and is governed exclusively by these terms and conditions.',
      },
      { type: 'h3', text: 'Participation and Process:' },
      {
        type: 'p',
        text:
          'The prediction game is publicly accessible. To participate, registration with a valid email address and the creation of a password are required. Participation is only possible within the specified time period. Predictions submitted after the respective deadlines will not be considered. Only one registration per participant is permitted. It is prohibited to use multiple email addresses to increase the chances of winning. If a participant has limited legal capacity, the consent of their legal representative is required. All persons involved in the conception and implementation of the prediction game are excluded from participation. The operator reserves the right to exclude participants at its own discretion if there are valid reasons, in particular: in the event of manipulation related to access or the conduct of the prediction game, violations of these terms and conditions, unfair conduct, or false or misleading information provided during participation.',
      },
      { type: 'h3', text: 'Prizes, Notification and Delivery:' },
      {
        type: 'p',
        text:
          'The prizes to be won in the prediction game will be announced on the website of the game. Winners will be determined according to the rules defined within the game. Winners will be notified of their prize by email after the conclusion of the game. Prizes will only be awarded to the winner or, in the case of minors, to their legal representative. Exchange, self-collection, or cash payment of prizes is not possible. Any shipping costs incurred for prize delivery will be covered by the operator. If a winner does not respond within three weeks after being contacted twice, the prize may be transferred to another participant. The organizer expressly reserves the right to terminate the prediction game without prior notice and without stating reasons, particularly if proper execution cannot be guaranteed.',
      },
      { type: 'h3', text: 'Applicable Law:' },
      {
        type: 'p',
        text:
          'Questions or complaints related to the prediction game should be addressed to the operator. Contact details can be found in the website’s legal notice. The prediction game is subject exclusively to the laws of the Federal Republic of Germany. Legal recourse is excluded.',
      },
      { type: 'h3', text: 'Severability Clause:' },
      {
        type: 'p',
        text:
          'Should any provision of these terms and conditions be or become invalid in whole or in part, the validity of the remaining provisions shall remain unaffected. In place of the invalid provision, a legally permissible provision that most closely reflects the economic purpose of the invalid provision shall apply. The same applies in the event of a regulatory gap.',
      },
      {
        type: 'p',
        text:
          'Further information on participation in the World Cup competition, where offered, may be found at third-party-operated pages referenced in the campaign (for example: Kicktipp where that campaign applies).',
      },
    ],
  },
  {
    id: 'advent-calendar',
    title: 'Terms and Conditions – Advent Calendar',
    blocks: [
      {
        type: 'p',
        text:
          'Participation in the Suhaili Security Advent Calendar competition, hereinafter referred to as the operator or organizer, is free of charge and is governed exclusively by these terms and conditions of participation.',
      },
      {
        type: 'p',
        text:
          'The competition runs from December 1, 2025, to December 24, 2025. During this period, users have the opportunity to participate online daily. To take part in the competition, participants must complete and submit the displayed entry form. Participation is only possible within the participation period. Entries received after the closing date will not be considered in the draw. Each participant may only submit one entry. It is strictly prohibited to use multiple email addresses to increase the chances of winning. Participation is open exclusively to employees of Suhaili Security and its group of companies (unless a different scope is expressly stated in the respective campaign announcement). If a participant has limited legal capacity, the consent of their legal representative is required. All persons involved in the design and implementation of the competition, as well as their employees, are excluded from participation. Furthermore, the operator reserves the right, at its own discretion, to exclude persons from participation for legitimate reasons, for example (a) in cases of manipulation in relation to access to or the conduct of the competition, (b) in cases of violations of these terms and conditions of participation, (c) in cases of unfair conduct, or (d) in cases of false or misleading information in connection with participation in the competition.',
      },
      { type: 'h3', text: 'Prize, Notification, and Delivery of the Prize:' },
      {
        type: 'p',
        text:
  ...
  {
    id: 'audio-video-conferences',
    title: 'Audio and Video Conferences',
    blocks: [
      {
        type: 'p',
        text:
          'To communicate with our customers, suppliers, business partners, employees, applicants, etc., we use online conferencing tools, among other methods. The specific tools we use are listed below. When you communicate with us via video or audio conference over the Internet, your personal data is collected and processed by us and the provider of the respective conferencing tool.',
      },
      {
        type: 'p',
        text:
      ...
      },
      {
        type: 'p',
        text:
          'If content is shared, uploaded, or otherwise made available via the tool, this content may also be stored on the servers of the tool providers. Such content includes, in particular, cloud recordings (e.g., various recording layouts, including active speaker, gallery view, and shared screen), chat/instant messages, voicemails, uploaded photos and videos, files, whiteboards, and other information shared during the use of the service.',
      },
      {
        type: 'p',
        text:
      ...
      { type: 'h3', text: 'Purpose and Legal Basis' },
      {
        type: 'p',
        text:
      ...
      { type: 'h3', text: 'Conferencing Tools Used' },
      { type: 'h3', text: 'Microsoft Teams' },
      {
        type: 'p',
        text:
      ...
      { type: 'h3', text: 'Zoom' },
      {
        type: 'p',
        text:
          'We use Zoom Meetings offered by Zoom Video Communications, Inc., with EU operations through Zoom Video Communications Limited, 70 Sir John Rogerson’s Quay, Dublin 2, Ireland, and headquarters at 55 Almaden Blvd., Suite 1700, San Jose, CA 95113, USA.',
      },
      {
        type: 'p',
        text:
          'Processing may include third-country transfers; safeguards such as EU standard contractual clauses and, where applicable, the EU-U.S. Data Privacy Framework are described in Zoom’s notices.',
      },
      {
        type: 'p',
        text: 'You can find Zoom’s privacy policy at: https://www.zoom.com/en/trust/privacy/',
      },
    ],
  },
]
